#!/usr/bin/env python3
# Copyright (c) 2012-2018 The Potahcoin Core developers
...
bech32_templates = [
  ...
  ('potah',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('potah',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('potah',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('potah',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tpotah',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpotah',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpotah',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpotah',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tpotah',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tpotah',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tpotah',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tpotah',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rpotah',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rpotah',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rpotah',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rpotah', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tpotah',   17, 32, Encoding.BECH32M, False, False, False),
  ('rpotah',  3,  1, Encoding.BECH32M, False, False, False),
  ('potah',   15, 41, Encoding.BECH32M, False, False, False),
  ('tpotah',    0, 16, Encoding.BECH32,  False, False, False),
  ('rpotah',  0, 32, Encoding.BECH32,  True,  False, False),
  ('potah',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tpotah',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rpotah',  0, 20, Encoding.BECH32,  False, False, True),
  ('potah',    0, 20, Encoding.BECH32M, False, False, False),
  ('tpotah',    0, 32, Encoding.BECH32M, False, False, False),
  ('rpotah',  0, 20, Encoding.BECH32M, False, False, False),
  ('potah',    1, 32, Encoding.BECH32,  False, False, False),
  ('tpotah',    2, 16, Encoding.BECH32,  False, False, False),
  ('rpotah', 16, 20, Encoding.BECH32,  False, False, False),
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['potah', 'tpotah', 'rpotah']:
