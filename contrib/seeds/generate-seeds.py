#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Potahcoin Core developers
...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef POTAHCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define POTAHCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the potahcoin network\n')
    ...
    g.write('#endif // POTAHCOIN_CHAINPARAMSSEEDS_H\n')
