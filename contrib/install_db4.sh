...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the potahcoin repository."
  exit 1
fi
...
# See https://github.com/potahcoin/potahcoin/issues/16064
...
echo 'When compiling potahcoind, run `./configure` in the following way:'
echo
