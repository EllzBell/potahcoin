# Bootstrappable Potahcoin Core Builds

This directory contains the files necessary to perform bootstrappable Potahcoin
Core builds.
...
- 24GB of free disk space on the partition that the Potahcoin Core git repository
  resides in
...
For a Potahcoin Core depends development environment, simply invoke
...
From the top of a clean Potahcoin Core repository:
...
To use dongcarl's substitute server for Potahcoin Core builds after having
