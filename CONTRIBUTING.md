Contributing to Potahcoin Core
============================

The Potahcoin Core project operates an open contributor model where anyone is
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/potahcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to potahcoin-qt
...
The following applies to code changes to the Potahcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Potahcoin
Network Protocol consensus changes.

Whether a pull request is merged into Potahcoin Core rests with the project merge
...
Patches that change Potahcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Potahcoin consensus, it must have been
...
The project leader is the release manager for each Potahcoin Core release.
