...
// potahcoin includes.
#include <..\src\script\potahcoinconsensus.h>
...
int main()
{
    std::cout << "potahcoinconsensus version: " << potahcoinconsensus_version() << std::endl;
    ...
    auto op0Result = potahcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, potahcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
