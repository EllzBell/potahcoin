...
class SegWitTest(PotahcoinTestFramework):
    ...
    def test_v0_outputs_arent_spendable(self):
        ...
        for tx in [p2wsh_tx, p2sh_p2wsh_tx]:
            ...
            # Potahcoin: BTC applied these rules for all transactions once P2SH is enabled, on LTC we enforce
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older potahcoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let potahcoind fill it in.
    ...
    def test_superfluous_witness(self):
        ...
        self.nodes[0].generate(1)
        unspent = next(u for u in self.nodes[0].listunspent() if u['spendable'] and u['address'].startswith('rpotah'))
