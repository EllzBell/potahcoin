...
class TestPotahcoinCli(PotahcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `potahcoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and potahcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test potahcoin-cli -generate with -rpcwallet in multiwallet mode.
