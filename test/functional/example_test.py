...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PotahcoinTestFramework
    pass


class ExampleTest(PotahcoinTestFramework):
    # Each functional test is a subclass of the PotahcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PotahcoinTestFramework class so other tests can use it."""
