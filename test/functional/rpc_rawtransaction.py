...
class RawTransactionsTest(PotahcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Potahcoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/potahcoin/potahcoin/issues/20579)
