...
class TestShell:
    """Wrapper Class for PotahcoinTestFramework.

    The TestShell class extends the PotahcoinTestFramework
    ...
    class __TestShell(PotahcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PotahcoinTestFramework child class.
            self.num_nodes = 1
