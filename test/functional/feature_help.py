...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start potahcoin with -h for help text")
        ...
        self.log.info("Start potahcoin with -version for version information")
        ...
        self.log.info("Start potahcoind with -fakearg to make sure it does not start")
