...
By default, potahcoind will dump mempool on shutdown and
...
class MempoolPersistTest(PotahcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent potahcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
