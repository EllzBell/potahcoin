    ...
    platformStyle(_platformStyle)
{
    ...
    // normal potahcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying potahcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &PotahcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
