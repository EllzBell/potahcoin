...
bool RPCConsole::eventFilter(QObject* obj, QEvent *event)
{
    ...
    {
        QKeyEvent *ksproutvt = static_cast<QKeyEvent*>(event);
        int key = ksproutvt->key();
        Qt::KeyboardModifiers mod = ksproutvt->modifiers();
        switch(key)
        {
        ...
        case Qt::Key_PageDown:
            if(obj == ui->lineEdit)
            {
                QApplication::postEvent(ui->messagesWidget, new QKeyEvent(*ksproutvt));
                return true;
            }
            break;
        case Qt::Key_Return:
        case Qt::Key_Enter:
            ...
            if(obj == autoCompleter->popup()) {
                QApplication::postEvent(ui->lineEdit, new QKeyEvent(*ksproutvt));
        ...
        default:
            ...
            if(obj == ui->messagesWidget && (
                  (!mod && !ksproutvt->text().isEmpty() && key != Qt::Key_Tab) ||
