...
#ifndef POTAHCOIN_QT_SENDCOINSENTRY_H
#define POTAHCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending potahcoins.
...
#endif // POTAHCOIN_QT_SENDCOINSENTRY_H
