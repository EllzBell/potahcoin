...
#ifndef POTAHCOIN_QT_GUIUTIL_H
#define POTAHCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Potahcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "potahcoin:" URI into recipient object, return true on successful parsing
