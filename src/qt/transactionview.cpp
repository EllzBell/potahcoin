    ...
    QWidget(parent)
{
    ...
    watchOnlyWidget->addItem(platformStyle->SingleColorIcon(":/icons/sprout_plus"), "", TransactionFilterProxy::WatchOnlyFilter_Yes);
    watchOnlyWidget->addItem(platformStyle->SingleColorIcon(":/icons/sprout_minus"), "", TransactionFilterProxy::WatchOnlyFilter_No);
...
void TransactionView::changedAmount()
{
    ...
    if (PotahcoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amountWidget->text(), &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(PotahcoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
