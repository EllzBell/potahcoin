...
//! Entry point for PotahcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PotahcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PotahcoinGUI tests.
void AppTests::guiTests(PotahcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PotahcoinGUI::consoleShown, this, &AppTests::consoleTests);
