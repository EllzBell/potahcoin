    ...
    mapper(nullptr)
{
    ...
    ui->potahcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->potahcoinAtStartup);
    ...
    ui->potahcoinAtStartup->setToolTip(ui->potahcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->potahcoinAtStartup->setText(ui->potahcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPotahcoinConfButton->setToolTip(ui->openPotahcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PotahcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->potahcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPotahcoinConfButton_clicked()
{
