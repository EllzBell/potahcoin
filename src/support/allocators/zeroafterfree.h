...
#ifndef POTAHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define POTAHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // POTAHCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
