// Copyright (c) 2017-2018 The Potahcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef POTAHCOIN_WALLET_COINSELECTION_H
#define POTAHCOIN_WALLET_COINSELECTION_H
...
#endif // POTAHCOIN_WALLET_COINSELECTION_H
