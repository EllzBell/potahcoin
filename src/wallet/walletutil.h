...
#ifndef POTAHCOIN_WALLET_WALLETUTIL_H
#define POTAHCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! potahcoin from opening the wallet, thinking it was newly created, and
...
#endif // POTAHCOIN_WALLET_WALLETUTIL_H
