...
#ifndef POTAHCOIN_WALLET_WALLET_H
#define POTAHCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this potahcoin node, and set to 0 for transactions that were created
...
#endif // POTAHCOIN_WALLET_WALLET_H
