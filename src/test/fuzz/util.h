...
#ifndef POTAHCOIN_TEST_FUZZ_UTIL_H
#define POTAHCOIN_TEST_FUZZ_UTIL_H
...
CNode ConsumeNode(FuzzedDataProvider& fuzzed_data_provider) noexcept
{
    ...
    const uint64_t ksproutd_net_group = fuzzed_data_provider.ConsumeIntegral<uint64_t>();
    ...
    return {node_id, local_services, my_starting_height, socket, address, ksproutd_net_group, local_host_nonce, addr_bind, addr_name, conn_type, inbound_onion};
}
...
#endif // POTAHCOIN_TEST_FUZZ_UTIL_H
