...
#ifndef POTAHCOIN_TEST_SCRIPTNUM10_H
#define POTAHCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Potahcoin Core 0.10.0, for cross-comparison.
 */
public:
