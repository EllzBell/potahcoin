...
#ifndef POTAHCOIN_CONSENSUS_PARAMS_H
#define POTAHCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Potahcoin Script solution
...
#endif // POTAHCOIN_CONSENSUS_PARAMS_H
