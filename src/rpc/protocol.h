...
#ifndef POTAHCOIN_RPC_PROTOCOL_H
#define POTAHCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in potahcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Potahcoin is not connected
...
#endif // POTAHCOIN_RPC_PROTOCOL_H
