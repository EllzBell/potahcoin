 ...
 * for both potahcoind and potahcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("PotahcoinCore");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/potahcoin/bips/blob/master/bip-0014.mediawiki)
 */
