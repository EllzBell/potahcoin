...
#ifndef POTAHCOIN_SCRIPT_DESCRIPTOR_H
#define POTAHCOIN_SCRIPT_DESCRIPTOR_H
 ...
 * but in cases where private keys need to be convsproutd along with a descriptor,
...
#endif // POTAHCOIN_SCRIPT_DESCRIPTOR_H
