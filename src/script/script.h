...
#ifndef POTAHCOIN_SCRIPT_SCRIPT_H
#define POTAHCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Potahcoin always counted CHECKMULTISIGs
...
#endif // POTAHCOIN_SCRIPT_SCRIPT_H
