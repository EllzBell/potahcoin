...
static void SetupPotahcoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " potahcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  potahcoin-tx [options] <hex-tx> [commands]  Update hex-encoded potahcoin transaction\n" +
            "or:     potahcoin-tx [options] -create [commands]   Create hex-encoded potahcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded potahcoin transaction
