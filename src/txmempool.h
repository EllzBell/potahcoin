...
#ifndef POTAHCOIN_TXMEMPOOL_H
#define POTAHCOIN_TXMEMPOOL_H
...
public:
    ...
    /**
     * FIFO cache of txs recently removed from the mempool ksproutd by kernel ID.
     */
