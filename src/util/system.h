 ...
 */
#ifndef POTAHCOIN_UTIL_SYSTEM_H
#define POTAHCOIN_UTIL_SYSTEM_H
...
extern const char * const POTAHCOIN_CONF_FILENAME;
extern const char * const POTAHCOIN_SETTINGS_FILENAME;
