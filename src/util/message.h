...
#ifndef POTAHCOIN_UTIL_MESSAGE_H
#define POTAHCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's potahcoin address, it must refer to a public key.
...
#endif // POTAHCOIN_UTIL_MESSAGE_H
