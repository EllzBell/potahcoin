Potahcoin Core version 0.16.3 is now available from:

  <https://potahcoincore.org/bin/potahcoin-core-0.16.3/>
...
been discovered in Potahcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` potahcoinconsensus: invalid flags error should be set to `potahcoinconsensus_err` (afk11)
