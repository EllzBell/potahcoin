Potahcoin Core version 0.9.4 is now available from:

  https://potahcoin.org/bin/0.9.4/
...
this update is incompatible with the Potahcoin system and could lead to consensus
forks.

Potahcoin Core released binaries from https://potahcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~potahcoin/+archive/ubuntu/potahcoin
- A third-party or self-compiled Potahcoin Core

upgrade to Potahcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
