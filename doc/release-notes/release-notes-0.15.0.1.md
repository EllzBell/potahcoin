Potahcoin Core version *0.15.0.1* is now available from:

  <https://potahcoin.org/bin/potahcoin-core-0.15.0.1/>

and

  <https://potahcoincore.org/bin/potahcoin-core-0.15.0.1/>
