...
Potahcoin Core version 0.21.0 is now available from:

  <https://potahcoincore.org/bin/potahcoin-core-0.21.0/>
...
- This release adds support for signets
  ([BIP325](https://github.com/potahcoin/bips/blob/master/bip-0325.mediawiki)) in
...
Bugs and missing functionality can be reported to the [issue tracker](https://github.com/potahcoin/potahcoin/issues).
...
Users who already have a Potahcoin Core wallet can continue to use it as they did before without
any change in behavior. Newly created Legacy Wallets (which remains the default type of wallet) will
behave as they did in previous versions of Potahcoin Core.
...
The change to using descriptors changes the default derivation paths used by Potahcoin Core
...
- #19284 Add seed.potahcoin.wiz.biz to DNS seeds (wiz)
...
- #20198 Show name, format and if uses descriptors in potahcoin-wallet tool (jonasschnelli)
...
- #19133 rpc, cli, test: add potahcoin-cli -generate command (jonatack)
...
- #20055 Set HTTP Content-Type in potahcoin-cli (laanwj)
...
### Build system
- #18504 Drop potahcoin-tx and potahcoin-wallet dependencies on libevent (ryanofsky)
...
- #18297 Use pkg-config in POTAHCOIN_QT_CONFIGURE for all hosts including Windows (hebasto)
...
- #18653 add coverage for potahcoin-cli -rpcwait (jonatack)
...
- #18739 Document how to fuzz Potahcoin Core using Honggfuzz (practicalswift)
...
- #19061 Add link to Visual Studio build readme (maitrepotahcoin)
...
- #18817 Document differences in potahcoind and potahcoin-qt locale handling (practicalswift)
