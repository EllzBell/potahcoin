Potahcoin Core version 0.10.4 is now available from:

  <https://potahcoin.org/bin/potahcoin-core-0.10.4/>
...
- #6953 `43c2789` Split potahcoin-tx into its own package
- #6953 `dfe0d4d` Include potahcoin-tx binary on Debian/Ubuntu
