Potahcoin Core version *0.15.2* is now available from:

  <https://potahcoincore.org/bin/potahcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in potahcoin-tx (TheBlueMatt)
