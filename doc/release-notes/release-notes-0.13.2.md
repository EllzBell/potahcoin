Potahcoin Core version 0.13.2 is now available from:
  ...
  <https://potahcoin.org/bin/potahcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update potahcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow potahcoin-tx to create v2 transactions (btcdrak)
