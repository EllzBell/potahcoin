...
This document provides guidelines for internationalization of the Potahcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `potahcoin_en.ts` remains unchanged.
