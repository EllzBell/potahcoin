Potahcoin Core version 0.16.2 is now available from:

  <https://download.potahcoin.org/potahcoin-0.16.2/>
...
- #12843 `df38b13` Test starting potahcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure potahcoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` potahcoinconsensus: invalid flags should be set to potahcoinconsensus_error type, add test cases covering potahcoinconsensus error codes (Thomas Kerin)
